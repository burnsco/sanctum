...
export function renderHook<Result, Props>(
  ...
  const { route = "/", queryClient = createTestQueryClient(), wrapper: CustomWrapper } = options;
...
export function buildSanctumRequest(overrides: Partial<SanctumRequest> = {}): SanctumRequest {
  return {
    id: 1,
