...
import { getChatDockStorageKey, useChatDockStore } from "@/stores/useChatDockStore";
...
describe("useLogout", () => {
  ...
  it("clears token/user, resets stores, clears scoped storage, and navigates to /login", async () => {
    ...
    expect(useChatDockStore.persist.getOptions().name).toBe(getChatDockStorageKey(null));
