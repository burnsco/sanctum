...
describe("useFriends hooks", () => {
  ...
  describe("usePendingRequests", () => {
    it("fetches incoming friend requests", async () => {
      ...
      vi.mocked(apiClient).getPendingRequests.mockResolvedValue(requests as never);
  ...
  describe("useSendFriendRequest", () => {
    it("calls API with userId", async () => {
      vi.mocked(apiClient).sendFriendRequest.mockResolvedValue(undefined as never);
  ...
  describe("useAcceptFriendRequest", () => {
    it("calls API with requestId", async () => {
      vi.mocked(apiClient).acceptFriendRequest.mockResolvedValue(undefined as never);
  ...
  describe("useRejectFriendRequest", () => {
    it("calls API with requestId", async () => {
      vi.mocked(apiClient).rejectFriendRequest.mockResolvedValue(undefined as never);
