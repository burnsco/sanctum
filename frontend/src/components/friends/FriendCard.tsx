    ...
    <Card className="overflow-hidden border border-border/40 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full group">
      ...
      <div className="p-3 flex flex-col flex-1 gap-3">
        <div className="flex-1 space-y-1">
          <Link to={`/users/${user.id}`} className="hover:underline decoration-foreground/50">
        ...
        <div className="space-y-2 mt-auto">
          {actionType === "add" && (
            <Button
              ...
              type="button"
            >
              {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Add Friend"}
            </Button>
          )}
          ...
          {actionType === "remove" && (
            <Button
              ...
              type="button"
            >
              {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Remove Friend"}
            </Button>
          )}
        </div>
      </div>
