...
import { buildFriendRequest, buildUser, createTestQueryClient } from "@/test/test-utils";
...
describe("FriendRequestList", () => {
  ...
  it("shows empty state when no requests", () => {
    ...
    renderWithProviders(<FriendRequestList />);
    expect(screen.getByText("No pending or sent friend requests.")).toBeInTheDocument();
  });
