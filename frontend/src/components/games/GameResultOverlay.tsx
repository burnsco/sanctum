...
export function GameResultOverlay({
  ...
  const confettiPieces = useMemo(() => createConfettiPieces(confettiColors), [confettiColors]);
  const defeatPieces = useMemo(() => createDefeatPieces(defeatColors), [defeatColors]);
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative flex h-72 w-72 items-center justify-center rounded-full bg-white/15 backdrop-blur-md">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-4xl font-black uppercase tracking-tight text-white">You Won</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative flex h-72 w-72 items-center justify-center rounded-full border border-slate-500/40 bg-black/55 backdrop-blur-md">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-4xl font-black uppercase tracking-tight text-slate-100">You Lost</p>
          </div>
        </div>
      </div>
    </div>
