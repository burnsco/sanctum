...
const ACCENT_STYLES = {
  blue: {
    content: "border-2 border-blue-400/30 bg-linear-to-br from-background to-blue-950/20",
    title: "text-blue-500",
    outline: "border-blue-500/20 hover:bg-blue-500/5",
  },
  emerald: {
    content: "border-2 border-emerald-400/30 bg-linear-to-br from-background to-emerald-950/20",
    title: "text-emerald-500",
    outline: "border-emerald-500/30 hover:bg-emerald-500/10",
  },
  teal: {
    content: "border-2 border-teal-400/30 bg-linear-to-br from-background to-teal-950/20",
    title: "text-teal-500",
    outline: "border-teal-500/20 hover:bg-teal-500/5",
  },
  amber: {
    content: "border-2 border-amber-400/30 bg-linear-to-br from-background to-amber-950/20",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={`${accent.content} sm:max-w-xl`}>
        ...
        <DialogFooter>
          <Button variant="outline" className={accent.outline} onClick={onLobby}>
            Back to Lobby
          </Button>
