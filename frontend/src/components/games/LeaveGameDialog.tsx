...
export function LeaveGameDialog({ open, onOpenChange, isLeaving, onLeave }: LeaveGameDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          <DialogTitle className="text-lg font-black uppercase">Leave Game?</DialogTitle>
