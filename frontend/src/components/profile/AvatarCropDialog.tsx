...
import { AVATAR_CROP_SIZE, getCroppedImageFile, type PixelCrop } from "@/lib/cropImage";
...
export function AvatarCropDialog({
  ...
  const handleConfirm = useCallback(async () => {
    ...
    try {
      ...
      const file = await getCroppedImageFile(imageSource, pixelCrop, AVATAR_CROP_SIZE);
      onConfirm(file);
      onOpenChange(false);
    } catch (err) {
      ...
      <DialogContent className="max-w-md" aria-describedby="avatar-crop-desc">
        <DialogHeader>
          ...
          <DialogDescription id="avatar-crop-desc">
            Adjust the crop area. The image will be resized to {AVATAR_CROP_SIZE}×{AVATAR_CROP_SIZE}{" "}
