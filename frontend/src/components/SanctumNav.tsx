  ...
  return (
    <aside className="w-full rounded-xl border border-border/70 bg-card p-4 lg:sticky lg:top-20 lg:w-74 lg:self-start">
      <div className="mb-5 flex items-center justify-between">
        ...
        <Link to="/sanctums" className="text-xs font-semibold text-primary hover:underline">
          View all
        </Link>
      </div>
      ...
      <div className="space-y-5">
        ...
        <section className="space-y-1.5">
          ...
          <p className="px-2 text-xs text-muted-foreground">Follow/join support is coming soon.</p>
        </section>
      </div>
    </aside>
  );
