const TRUSTED_EXTERNAL_IMAGE_HOSTS = new Set(["picsum.photos", "img.youtube.com", "i.ytimg.com"]);
...
export function normalizeImageURL(url?: string): string | undefined {
  ...
  try {
    ...
    if (parsed.pathname.startsWith("/api/images/") || parsed.pathname.startsWith("/media/i/")) {
