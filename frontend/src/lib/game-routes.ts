export const SUPPORTED_GAME_TYPES = ["connect4", "othello", "battleship", "checkers"] as const;
...
export function isSupportedGameType(type: unknown): type is SupportedGameType {
  return typeof type === "string" && (SUPPORTED_GAME_TYPES as readonly string[]).includes(type);
}
