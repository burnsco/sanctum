...
import { useAdminBanRequests, useAdminReports, useAdminUsers } from "@/hooks/useAdminModeration";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        {cards.map((card) => (
          <article key={card.title} className="rounded-xl border border-border/70 bg-card/60 p-4">
