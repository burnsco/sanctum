...
export default function UserProfile() {
  ...
  const sampledPostsForComments = useMemo(() => userPosts.slice(0, 60), [userPosts]);
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="inline-flex items-center gap-1">
                  <UserRound className="h-3.5 w-3.5" /> {user.is_admin ? "Admin" : "Member"}
                </span>
              </div>
              ...
              <div className="flex justify-between">
                <span className="text-muted-foreground">Comments (sampled)</span>
