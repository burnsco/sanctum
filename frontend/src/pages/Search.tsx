...
export default function SearchPage() {
  ...
  const isLoading =
    ...
    (peopleQuery.isFetching && (activeTab === "all" || activeTab === "people")) ||
    (sanctumsQuery.isFetching && (activeTab === "all" || activeTab === "sanctums"));
            ...
            <Card className="divide-y divide-border/50 rounded-2xl border border-border/70 bg-card/70">
              {sanctums.map((sanctum) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-sm font-semibold">{sanctum.name}</p>
                    {sanctum.description && (
