...
import { ADMIN_STATE_PATH, readTokenFromStorageState, USER_STATE_PATH } from "./fixtures/auth";
import {
...
test.describe("Sanctum open chat", () => {
  ...
  test("open chat uses default_chat_room_id navigation @smoke", async ({ page, request }) => {
