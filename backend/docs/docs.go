                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/service.DeletedCommentRow"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/service.DeletedPostRow"
                            }
                        }
                    },
                    "500": {
    ...
    "definitions": {
        ...
        "models.Poll": {
            ...
            "properties": {
                ...
                "user_vote_option_id": {
                    "description": "filled when loading for current user",
                    "type": "integer"
                }
            }
        },
        "models.PollOption": {
            ...
            "properties": {
                ...
                "votes_count": {
                    "description": "VotesCount is computed when loading for display",
                    "type": "integer"
                }
            }
        },
